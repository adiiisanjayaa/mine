...
export const ASSETS: ThemeAssets = {
  // fonts
  OpenSansLight: require('../assets/fonts/SFUIDisplay-Light.ttf'),
  OpenSansRegular: require('../assets/fonts/SFUIDisplay-Regular.ttf'),
  OpenSansSemiBold: require('../assets/fonts/SFUIDisplay-SemiBold.ttf'),
  OpenSansExtraBold: require('../assets/fonts/SFUIDisplay-ExtraBold.ttf'),
  OpenSansBold: require('../assets/fonts/SFUIDisplay-Bold.ttf'),
